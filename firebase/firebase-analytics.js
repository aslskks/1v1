!function(e, t) {
    ...
    try {
        (function() {
            ...
            var C, O = 1e4, N = "w:0.3.1", k = "FIS_v2", A = "https://firebaseinstallations.googleapis.com/v1", j = 36e5, P = ((C = {})["missing-app-config-values"] = "Missing App configuration values.",
            C["create-installation-failed"] = "Could not register Firebase Installation.",
            ...
            C["request-failed"] = '{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',
            C["app-offline"] = "Could not process request. Application offline.",
            C["delete-pending-registration"] = "Can't delete installation while there is a pending registration request.",
            C), x = new u("installations","Installations",P);
            function D(e) {
                return e instanceof d && e.code.includes("request-failed")
            }
            function q(e) {
                if (!e || !e.options)
                    throw x.create("missing-app-config-values");
                var t = e.name
                  , n = e.options
                  , r = n.projectId
                  , i = n.apiKey
                ...
                return c(this, void 0, void 0, function() {
                    ...
                    return f(this, function(e) {
                        ...
                        case 1:
                            ...
                            [4, r]);
                        case 2:
                            return [2, (n.installationEntry = e.sent(),
                            n)];
                        case 3:
                            return [2, {
                                installationEntry: t,
            ...
            function re(e) {
                return ee(e, function(e) {
                    if (!e)
                        throw x.create("installation-not-found");
                    return ie(e)
                })
            }
            function ie(e) {
                            ...
                            return c(this, void 0, void 0, function() {
                                ...
                                return f(this, function(e) {
                                    ...
                                    case 1:
                                        ...
                                        (i = n.registrationPromise) && i.catch(function() {}),
                                        2 === r.registrationStatus && ae(t).catch(function() {}),
                                        [2, r.fid]
                                    }
                                })
                            })
            ...
            var le, de, pe, he, ve, ge = "measurementId", ye = "firebase_id", we = "origin";
            function be(e) {
            ...
            var me, Ee, Se = ((ve = {})["no-ga-id"] = '"' + ge + '" field is empty in Firebase config. Firebase Analytics requires this field to contain a valid measurement ID.',
            ve["already-exists"] = "A Firebase Analytics instance with the measurement ID ${id}  already exists. Only one Firebase Analytics instance can be created for each measurement ID.",
            ve["already-initialized"] = "Firebase Analytics has already been initialized.settings() must be called before initializing any Analytics instanceor it will have no effect.",
            ve), Ie = new u("analytics","Analytics",Se), Te = {}, Ce = "dataLayer", Oe = "gtag", Ne = !1;
            function ke(e) {
                if (Ne)
                    throw Ie.create("already-initialized");
                e.dataLayerName && (Ce = e.dataLayerName),
                e.gtagName && (Oe = e.gtagName)
            }
            function Ae(t, e) {
                if (!t.options[ge])
                    throw Ie.create("no-ga-id");
                var r = t.options[ge];
                if (null != Te[r])
                    throw Ie.create("already-exists", {
                        id: r
                    });
                if (!Ne) {
                    be(Ce) || function(e) {
                    ...
                    return c(this, void 0, void 0, function() {
                        ...
                        return f(this, function(e) {
                            ...
                            case 1:
                                return t = e.sent(),
                                i("js", new Date),
                                i(le.CONFIG, r.options[ge], ((n = {})[ye] = t,
                                n[we] = "firebase",
                                n.update = !0,
                                n)),
                                [2]
