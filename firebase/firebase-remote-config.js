!function(t, e) {
    ...
    try {
        (function() {
            ...
            var t, e, i, h = (i = Error,
            r(t = a, e = i),
            void (t.prototype = null === e ? Object.create(e) : (o.prototype = e.prototype,
            new o)),
            a);
            function o() {
                this.constructor = t
            ...
            function a(t, e) {
                ...
                Error.captureStackTrace && Error.captureStackTrace(r, c.prototype.create),
                r
            }
            ...
            function T(t, e, r) {
                this._db = t,
                this.oldVersion = e,
                this.transaction = new E(r)
            }
            function C(t) {
                this._db = t
            }
            d(b, "_index", ["name", "keyPath", "multiEntry", "unique"]),
            v(b, "_index", IDBIndex, ["get", "getKey", "getAll", "getAllKeys", "count"]),
            ...
            ["advance", "continue", "continuePrimaryKey"].forEach(function(r) {
                r in IDBCursor.prototype && (w.prototype[r] = function() {
                    ...
                    return Promise.resolve().then(function() {
                        return e._cursor[r].apply(e._cursor, t),
                        f(e._request).then(function(t) {
                            if (t)
                                return new w(t,e._request)
                        })
                    })
                }
                )
            ...
            v(S, "_store", IDBObjectStore, ["put", "add", "delete", "clear", "get", "getAll", "getKey", "getAllKeys", "count"]),
                ...
                t.prototype.getAll || (t.prototype.getAll = function(t, r) {
                    ...
                    return new Promise(function(e) {
                        n.iterateCursor(t, function(t) {
                            t ? (i.push(t.value),
                            void 0 === r || i.length != r ? t.continue() : e(i)) : e(i)
                        })
                    }
                    )
                }
            ...
            var I, k = 1e4, O = "w:0.3.1", F = "FIS_v2", M = "https://firebaseinstallations.googleapis.com/v1", P = 36e5, j = ((I = {})["missing-app-config-values"] = "Missing App configuration values.",
            I["create-installation-failed"] = "Could not register Firebase Installation.",
            ...
            I["request-failed"] = '{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',
            I["app-offline"] = "Could not process request. Application offline.",
            I["delete-pending-registration"] = "Can't delete installation while there is a pending registration request.",
            I), A = new c("installations","Installations",j);
            function L(t) {
                return t instanceof h && t.code.includes("request-failed")
            }
            function N(t) {
                if (!t || !t.options)
                    throw A.create("missing-app-config-values");
                var e = t.name
                  , r = t.options
                  , n = r.projectId
                  , i = r.apiKey
            ...
            var G, W, J = "firebase-installations-database", Y = 1, Q = "firebase-installations-store", X = null;
            function Z() {
            ...
            function tt(i, o) {
                return u(this, void 0, void 0, function() {
                    ...
                    return _(this, function(t) {
                        ...
                        case 1:
                            return r = t.sent(),
                            [4, (n = r.transaction(Q, "readwrite")).objectStore(Q).put(o, e)];
                        case 2:
                            return t.sent(),
                            [4, n.complete];
                        case 3:
            ...
            function et(i) {
                return u(this, void 0, void 0, function() {
                    ...
                    return _(this, function(t) {
                        ...
                        case 1:
                            return r = t.sent(),
                            [4, (n = r.transaction(Q, "readwrite")).objectStore(Q).delete(e)];
                        case 2:
                            return t.sent(),
                            [4, n.complete];
                        case 3:
                    ...
                    return _(this, function(t) {
                        ...
                        case 0:
                            return [4, rt(i, function(t) {
                                ...
                                return n = r.registrationPromise,
                                r.installationEntry
                            })];
                        case 1:
                            return (e = t.sent()).fid !== $ ? [3, 3] : (r = {},
                            [4, n]);
                        case 2:
                            return [2, (r.installationEntry = t.sent(),
                            r)];
                        case 3:
                            return [2, {
                                installationEntry: e,
            ...
            function ot(t) {
                return rt(t, function(t) {
                    if (!t)
                        throw A.create("installation-not-found");
                    return st(t)
                })
            }
            function st(t) {
                            ...
                            return u(this, void 0, void 0, function() {
                                ...
                                return _(this, function(t) {
                                    ...
                                    case 1:
                                        ...
                                        (i = r.registrationPromise) && i.catch(function() {}),
                                        2 === n.registrationStatus && ct(e).catch(function() {}),
                                        [2, n.fid]
                                    }
                                })
                            })
            ...
            var yt, bt = (wt.prototype.isCachedDataFresh = function(t, e) {
                ...
                var r = Date.now() - e
                  , n = r <= t;
                return this.logger.debug("Config fetch cache check. Cache age millis: " + r + ". Cache max age millis (minimumFetchIntervalMillis setting): " + t + ". Is cache hit: " + n + "."),
                n
            }
            ,
                ...
                return u(this, void 0, void 0, function() {
                    ...
                    return _(this, function(t) {
                        ...
                        case 1:
                            return e = t.sent(),
                            r = e[0],
                            (n = e[1]) && this.isCachedDataFresh(s.cacheMaxAgeMillis, r) ? [2, n] : (s.eTag = n && n.eTag,
                            [4, this.client.fetch(s)]);
                        case 2:
                            return i = t.sent(),
            ...
            var _t = ((yt = {})["registration-window"] = "Undefined window object. This SDK only supports usage in a browser environment.",
            yt["registration-project-id"] = "Undefined project identifier. Check Firebase app initialization.",
            yt["registration-api-key"] = "Undefined API key. Check Firebase app initialization.",
            yt["registration-app-id"] = "Undefined app identifier. Check Firebase app initialization.",
            yt["storage-open"] = "Error thrown when opening storage. Original error: {$originalErrorMessage}.",
            yt["storage-get"] = "Error thrown when reading from storage. Original error: {$originalErrorMessage}.",
            yt["storage-set"] = "Error thrown when writing to storage. Original error: {$originalErrorMessage}.",
            yt["storage-delete"] = "Error thrown when deleting from storage. Original error: {$originalErrorMessage}.",
            yt["fetch-client-network"] = "Fetch client failed to connect to a network. Check Internet connection. Original error: {$originalErrorMessage}.",
            yt["fetch-timeout"] = 'The config fetch request timed out.  Configure timeout using "fetchTimeoutMillis" SDK setting.',
            yt["fetch-throttle"] = 'The config fetch request timed out while in an exponential backoff state. Configure timeout using "fetchTimeoutMillis" SDK setting. Unix timestamp in milliseconds when fetch request throttling ends: {$throttleEndTimeMillis}.',
            yt["fetch-client-parse"] = "Fetch client could not parse response. Original error: {$originalErrorMessage}.",
            yt["fetch-status"] = "Fetch server returned an HTTP error status. HTTP status: {$httpStatus}.",
            yt)
                ...
                return u(this, void 0, void 0, function() {
                    ...
                    return _(this, function(t) {
                        ...
                        case 10:
                            ...
                            t.label = 11;
                        case 11:
                            if ("INSTANCE_STATE_UNSPECIFIED" === m ? g = 500 : "NO_CHANGE" === m ? g = 304 : "NO_TEMPLATE" !== m && "EMPTY_CONFIG" !== m || (v = {}),
                            304 !== g && 200 !== g)
                                throw St.create("fetch-status", {
                                    httpStatus: g
                                });
                            return [2, {
                                status: g,
                ...
                return u(this, void 0, void 0, function() {
                    ...
                    return _(this, function(t) {
                        ...
                        case 1:
                            ...
                            r = e[0],
                            n = e[1],
                            r && r.config && r.eTag && r.eTag !== n ? [4, Promise.all([this._storageCache.setActiveConfig(r.config), this._storage.setActiveConfigEtag(r.eTag)])] : [2, !1];
                        case 2:
                            return t.sent(),
                            [2, !0]
                        }
                            ...
                            return u(e, void 0, void 0, function() {
                                ...
                                return _(this, function(t) {
                                    ...
                                    case 4:
                                        ...
                                        }(r, "fetch-throttle") ? "throttle" : "failure",
            ...
            Pt.prototype.getValue = function(t) {
                ...
                return e && void 0 !== e[t] ? new Ot("remote",e[t]) : this.defaultConfig && void 0 !== this.defaultConfig[t] ? new Ot("default",String(this.defaultConfig[t])) : (this._logger.debug('Returning static value for key "' + t + '". Define a default or remote value if this is unintentional.'),
                new Ot("static"))
            }
            ,
            Pt);
                ...
                return u(this, void 0, void 0, function() {
                    ...
                    return _(this, function(t) {
                        ...
                        case 0:
                            ...
                            [4, e];
                        case 1:
                            return (i = t.sent()) && (this.lastFetchStatus = i),
                            [4, r];
                        case 2:
                            return (o = t.sent()) && (this.lastSuccessfulFetchTimestampMillis = o),
                            [4, n];
                        case 3:
                            return (s = t.sent()) && (this.activeConfig = s),
                            [2]
                        }
                    })
                })
                ...
                return u(this, void 0, void 0, function() {
                    ...
                    return _(this, function(t) {
                        ...
                        case 1:
                            ...
                            t.label = 2;
                        case 2:
                            return t.trys.push([2, 5, , 7]),
                            [4, this.client.fetch(i)];
                        case 3:
                            return e = t.sent(),
            ...
            (Vt = zt).INTERNAL.registerService("remoteConfig", function(t, e, r) {
                ...
                var n = t.options
                  ...
                  , s = n.appId;
                if (!i)
                    throw St.create("registration-project-id");
                if (!o)
                    throw St.create("registration-api-key");
                if (!s)
                    throw St.create("registration-app-id");
                r = r || "firebase";
        ...
        new Error("Cannot instantiate firebase-remote-config - be sure to load firebase-app.js first.")
    }
});
